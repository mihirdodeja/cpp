...
This project helps in understanding how real-world entities can be modeled using object-oriented programming principles in C++.</p>

<img src="./image.png" alt="code_image">